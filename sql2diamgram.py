...
# Program to help automate generation of SQL database diagrams. It generates a
# very basic diagram, but with enough detail to quickly get an overview of the
# database schema.
#
...
def grammar(tables, use_columns=True):
...
def graphviz(in_file, out_file, show_columns=True):
    ...
    tables = []
    grammar(tables, show_columns).setDebug(False).parseFile(in_file)
